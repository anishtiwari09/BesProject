...
export default function page() {
  return (
    ...
    >
      <h2 className="text-[26px] font-bold ">Products/Services on Display</h2>

      <br />
      <h4 className="font-bold text-[20px]"> 3D/VR Rigs</h4>

      <p className="font-bold">
        <br />
        <span class={styles.style1}>A</span>
        <br />
        Acoustic Products
        <br />
        Advertising Technology
        <br />
        Aerial Camera Support/ Video Platforms
        <br />
        Aerial Cinematographyl/Octocopters/Helicopters
        <br />
        Antennas
        <br />
        Archiving &amp; Storage
        ...
        <br />
        <br />
        <strong class={styles.style1}>B</strong>
        <br />
        Batteries / Charges
        <br />
        ...
        <br />
        Broadcast Equipments &amp; Solutions
        <br />
        Broadcast Management Systems
        <br />
        <br />
        <strong class={styles.style1}>C</strong>
        <br />
        Cable Connectors/ Headend Equipment
        <br />
        Cable Solution for Broadcast
        <br />
        ...
        <br />
        Computing/Networking/Storage/Database/Application Services
        <br />
        Content Creation
        <br />
        Customers Premise Equipment/ Set Top Boxes
        <br />
        <br />
        <strong class={styles.style1}>D</strong>
        <br />
        ...
        <br />
        Digital TV Studio Equipments
        <br />
        Digital Video Recorders
        <br />
        Digital Watermarking &amp; Fingerprinting/ Audience Measurement
        <br />
        Dimming &amp; Control Equipment
        <br />
        ...
        <br />
        <br />
        <strong class={styles.style1}>E</strong>
        <br />
        ...
        <br />
        <br />
        <strong class={styles.style1}>F</strong>
        <br />
        ...
        Film/ Tape
        <br />
        Film Cameras/ Digital Film Recorders
        <br />
        Film Restoration Solution
        <br />
        Film Scanner
        <br />
        Filter Camera/ Lights
        <br />
        Flash Card Recorders
        <br />
        Format Conversion / Telecine
        <br />
        <br />
        <strong class={styles.style1}>G</strong>
        <br />
        Gaming
        <br />
        ...
        <br />
        <br />
        <strong class={styles.style1}>H</strong>
        <br />
        Headphones
        <br />
        High Speed Camera
        <br />
        High Speed Video Analysis/Real Time Video Analysis
        <br />
        Hydrophilic&nbsp; Coating Filters
        <br />
        <br />
        <strong class={styles.style1}>I</strong>
        <br />
        Image Converters
        <br />
        ...
        <br />
        Interactive Advertising Applications/ Solutions
        <br />
        ...
        <br />
        <br />
        <strong class={styles.style1}>L</strong>
        <br />
        ...
        <br />
        LNB/Easy Find LNB/Special Sat Finder LNB
        <br />
        <br />
        <strong class={styles.style1}>M</strong>
        <br />
        ...
        <br />
        Modulators/Receivers/Switchers
        <br />
        ...
        <br />
        <br />
        <strong class={styles.style1}>N</strong>
        <br />
        News/Weather/Traffic Services
        <br />
        <br />
        <strong class={styles.style1}>O</strong>
        <br />
        ...
        <br />
        <br />
        <strong class={styles.style1}>P</strong>
        <br />
        ...
        <br />
        <br />
        <strong class={styles.style1}>R</strong>
        <br />
        ...
        RF Accessories
        <br />
        Routers/Phone-in-interface/Patch Panels/Voice Processors/Profanity
        Delays/IP Audio Codes/ Multiviewers/Intercom
        <br />
        <br />
        <strong class={styles.style1}>S</strong>
        <br />
        Sales (Sales Support/Advertising Sales/ Out Sourcing)
        <br />
        Satellite
        <br />
        ...
        Servers/Storage/HPC
        <br />
        Software/Applications/Middleware / Development
        <br />
        ...
        <br />
        Sporting Events/ Sportscasting
        <br />
        Stereoscopic 3D Systems &amp; Equipments
        <br />
        Stock Footage/ Video &amp; Image Libraries
        <br />
        Storage &amp; Management
        <br />
        ...
        <br />
        <br />
        <strong class={styles.style1}>T</strong>
        <br />
        ...
        <br />
        <br />
        <strong class={styles.style1}>U</strong>
        <br />
        Used Equipment
        <br />
        <br />
        <strong class={styles.style1}>V</strong>
        <br />
        ...
        <br />
        Visual Effects/ Digital Visual Effects
        <br />
        <br />
        <strong class={styles.style1}>W</strong>
        <br />
